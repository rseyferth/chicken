...
import PivotCollection from './PivotCollection';
...
export default class Relationship {
    ...
    touchLocalOnUpdate : boolean = false;
	...
	hasMany(remoteModel : string, localKey : string = 'id', remoteKey? : string) : Relationship {

		// Basics
		this.type = Relationship.HasMany;
		this.remoteModel = remoteModel;
		let cleanModel : string = _.last(this.localModel.split('.'))!;
	...
	belongsTo(remoteModel : string, localKey?: string, remoteKey : string = 'id') : Relationship {
	...
	hasOne(remoteModel : string, localKey : string = 'id', remoteKey? : string) : Relationship {
	...
	belongsToMany(remoteModel : string, localKey : string = 'id', remoteKey : string = 'id', pivotModel? : string) : Relationship {
	...
	belongsToMorph(morphModelKey : string, localKey : string, remoteKey : string = 'id', morphModelValuePrefix : string = 'App\\') : Relationship {
	...
	hasManyMorph(remoteModel : string, morphModelKey : string, localKey? : string, remoteKey : string = 'id', morphModelValuePrefix : string = 'App\\') : Relationship {
	 ...
	 */
	touchLocal(value : boolean = true) : Relationship {
    ...
    static HasMany : string = 'HasMany';
    static HasOne : string = 'HasOne';
    static BelongsTo : string = 'BelongsTo';
    
    static HasManyThrough : string = 'HasManyThrough';
    static BelongsToMany : string = 'BelongsToMany';
    
    static BelongsToMorph : string = 'BelongsToMorph';
    static HasManyMorph : string = 'HasManyMorph';
