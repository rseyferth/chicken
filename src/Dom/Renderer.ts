...
import HelperProxy from './HelperProxy';
...
export default class Renderer
{
	...
	constructor() {
		...
		this.hooks = _.defaults({
			 ...
			 */
			get: (renderer : Renderer, scope : Scope, path : string) => {
			 ...
			 * @return 
			 */
			linkRenderNode: (morph : Morph, renderer : Renderer, scope : Scope, type : string, values : any[]) => {
			...
			willRenderNode: (morph : Morph/*, renderer, scope*/) => {
			...
			subexpr: (renderer : Renderer, scope : Scope, helperName : string, params : any[], hash : Dictionary<any>) => {
				...
				// Original behavior
				return Hooks.Default.subexpr(renderer, scope, helperName, params, hash);
			 ...
			 * @return {string}          
			 */
			classify: (renderer : Renderer, scope : Scope, path : string) => {
